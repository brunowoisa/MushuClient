<?php 
Class movimentacao_mod extends CI_Model {
  ...
  public function grid_movimentacao_convenios(){
    ...
    $this->db->where('cliente_veiculo.id_cliente', $this->session->userdata('cliente_autorizado')->id_cliente);
  ...
  public function get_movimentacao_convenio($id_movimentacao_convenio){
    $this->db->select('movimentacao_convenio.*, cliente_fornecedor.nome as nome_cliente, cliente_veiculo.placa as placa, cliente_autorizado.nome as nome_autorizado');
    $this->db->from('movimentacao_convenio');
    $this->db->join('cliente_fornecedor', 'cliente_fornecedor.id = movimentacao_convenio.id_cliente');
    $this->db->join('cliente_veiculo', 'cliente_veiculo.id = movimentacao_convenio.id_veiculo');
    $this->db->join('cliente_autorizado', 'cliente_autorizado.id = movimentacao_convenio.id_autorizado');
    $this->db->where('movimentacao_convenio.id', $id_movimentacao_convenio);
