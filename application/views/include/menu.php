<ul class="nav nav-sidebar">
  ...
  <!-- <li class="nav-parent nav-active active">
    <a href="#"><i class="fa fa-database"></i><span>Cadastros</span> <span class="fa arrow"></span></a>
    <ul class="children collapse">
      <li class="active"><a href="#"> Clientes e Fornecedores</a></li>
    </ul>
  </li> -->

  <li><a href="<?php echo base_url(); ?>Home/"><i class="fa fa-home"></i><span>Início</span></a></li>
