          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span><b>Mushu</b> <span class="copyright">©</span> <?php echo date('Y'); ?> </span>
                <span>| Powered by Bruno Woisa</span>
              </p>
              <p class="pull-right sm-pull-reset">
                <span><a href="#" class="m-r-10">Disposições Gerais</a> | <a href="#" class="m-l-10">Disposições Legais</a></span>
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="chat-body current">
              ...
              <div class="chat-list">
                ...
                <ul>
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar13.png" alt="avatar" />
                    </div>
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar5.png" alt="avatar" />
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar10.png" alt="avatar" />
                    </div>
                    <div class="user-details">
                      <div class="user-name">Bobby Brown</div>
              ...
              <div class="chat-list">
                ...
                <ul>
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar7.png" alt="avatar" />
                      <div class="pull-right badge badge-danger">3</div>
                    </div>
                    <div class="user-details">
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar11.png" alt="avatar" />
                    </div>
                    <div class="user-details">
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar8.png" alt="avatar" />
                    </div>
                    <div class="user-details">
      ...
      <div class="morphsearch-content withScroll">
        <div class="dummy-column user-column">
          ...
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar1_big.png" alt="Avatar 1"/>
            <h3>John Smith</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar2_big.png" alt="Avatar 2"/>
            <h3>Bod Dylan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar3_big.png" alt="Avatar 3"/>
            <h3>Jenny Finlan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar4_big.png" alt="Avatar 4"/>
            <h3>Harold Fox</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar5_big.png" alt="Avatar 5"/>
            <h3>Martin Hendrix</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/avatars/avatar6_big.png" alt="Avatar 6"/>
            <h3>Paul Ferguson</h3>
          </a>
        </div>
        <div class="dummy-column">
          <h2>Articles</h2>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/1.jpg" alt="1"/>
            <h3>How to change webdesign?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/2.jpg" alt="2"/>
            <h3>News From the sky</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/3.jpg" alt="3"/>
            <h3>Where is the cat?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/4.jpg" alt="4"/>
            <h3>Just another funny story</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/5.jpg" alt="5"/>
            <h3>How many water we drink every day?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/6.jpg" alt="6"/>
        ...
        <div class="dummy-column">
          <h2>Recent</h2>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/7.jpg" alt="7"/>
            <h3>Design Inspiration</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/8.jpg" alt="8"/>
            <h3>Animals drawing</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/9.jpg" alt="9"/>
            <h3>Cup of tea please</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/10.jpg" alt="10"/>
            <h3>New application arrive</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/11.jpg" alt="11"/>
            <h3>Notification prettify</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo base_url(); ?>assets/global/images/gallery/12.jpg" alt="12"/>
    ...
    <script src="<?php echo base_url(); ?>assets/global/plugins/jquery-block-ui/jquery.blockUI.min.js"></script>


    <!-- Modal with Validation -->
    <script src="<?php echo base_url(); ?>assets/global/plugins/bootbox/bootbox.min.js"></script>
    <!-- Custom Scrollbar sidebar -->
    <script src="<?php echo base_url(); ?>assets/global/plugins/mcustom-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <!-- Show Dropdown on Mouseover -->
    <script src="<?php echo base_url(); ?>assets/global/plugins/bootstrap-dropdown/bootstrap-hover-dropdown.min.js"></script>
    <!-- Charts Sparkline -->
    <script src="<?php echo base_url(); ?>assets/global/plugins/charts-sparkline/sparkline.min.js"></script>
    <!-- Retina Display -->
    <script src="<?php echo base_url(); ?>assets/global/plugins/retina/retina.min.js"></script>
    <!-- Select Inputs -->
    <script src="<?php echo base_url(); ?>assets/global/plugins/select2/dist/js/select2.full.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/global/plugins/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/global/plugins/charts-chartjs/Chart.min.js"></script>
    <!-- Theme Builder -->
    <script src="<?php echo base_url(); ?>assets/global/js/builder.js"></script>
    <!-- Sidebar on Hover -->
    <script src="<?php echo base_url(); ?>assets/global/js/sidebar_hover.js"></script>
    <!-- Notes Widget -->
    <script src="<?php echo base_url(); ?>assets/global/js/widgets/notes.js"></script>
    <!-- Chat Script -->
    <script src="<?php echo base_url(); ?>assets/global/js/quickview.js"></script>
    <!-- Search Script -->
    <script src="<?php echo base_url(); ?>assets/global/js/pages/search.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/global/plugins/timepicker/jquery-ui-timepicker-addon.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/global/plugins/multidatepicker/multidatespicker.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/global/plugins/colorpicker/spectrum.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/global/plugins/rateit/jquery.rateit.min.js"></script> -->
    <!-- <script src="<?php echo base_url(); ?>assets/global/plugins/bootstrap-datepicker/locales/bootstrap-datepicker.pt-BR.min.js"></script> -->
    <script src="<?php echo base_url(); ?>assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>



    <!-- Modal que exibe erros dos formularios -->
    <?php if (isset($form_erros)): ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p><?php echo $form_erros; ?></p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Fechar</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <?php if (isset($error)): ?>
      <?php echo "aisjdoiajsdoiajsd"; ?>
      <div class="modal fade" id="modal-erro" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content bg-red">
            ...
            <div class="modal-body">
              <p style="text-align: center; font-size: 55px;"><i class="fa fa-warning faa-flash animated undefined visible"></i></p>
              <p style="text-align: center; font-size: 25px;"><?php echo $error; ?></p>
            </div>
            <div class="modal-footer">
    ...
    <?php endif ?>
    <!-- Modal que exibe mensagem de Sucesso -->
      ...
      <div class="modal fade" id="modal-sucesso" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content bg-green">
            ...
            <div class="modal-body">
              <p style="text-align: center; font-size: 55px;"><i class="fa fa-thumbs-o-up faa-bounce animated undefined visible"></i></p>
              <p style="text-align: center; font-size: 25px;"><?php echo $success; ?></p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-white" data-dismiss="modal">Fechar</button>
            </div>
    ...
    <?php endif ?>
    <!-- Modal de Busca Direta -->
    <div class="modal fade" id="busca_direta" aria-hidden="true">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="icons-office-52"></i></button>
            <h4 class="modal-title">Busca Direta</h4>
          </div>
          <div class="modal-body">
            <p>Informe o código do registro a ser buscado.</p>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <input type="text" class="form-control" id="busca_direta_codigo" placeholder="Código">
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer text-center">
            <button type="button" onclick="busca_direta();" class="btn btn-primary btn-embossed bnt-square" data-dismiss="modal"><i class="fa fa-search"></i> Buscar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modal-log" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="icons-office-52"></i></button>
            <h4 class="modal-title">Relatório de Log</h4>
          </div>
          <div class="modal-body">
            <p id="modal_log_corpo"></p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-white" data-dismiss="modal">Fechar</button>
          </div>
    ...
    <script src="<?php echo base_url(); ?>assets/global/js/pages/animations.js"></script>
