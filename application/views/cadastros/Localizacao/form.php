<?php $this->load->view('include/top'); ?>
  <div class="panel">
    <div class="panel-header">
      <h3><i class="fa fa-cubes"></i>Cadastro de Localizações</h3>
    </div>
            ...
            <div class="tab-pane fade active in" id="geral">
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  ...
                  <input class="form-control <?php echo form_status('descricao'); ?>" style="text-transform: uppercase;" type="text"  name="descricao" maxlength="45" value="<?php echo set_form_value($editar,$form,'descricao'); ?>">
                </div>
              </div>
