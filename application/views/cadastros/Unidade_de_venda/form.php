<?php $this->load->view('include/top'); ?>
  <div class="panel">
    <div class="panel-header">
      <h3><i class="fa fa-cubes"></i>Cadastro de Unidades de Venda</h3>
    </div>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade active in" id="geral">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <label>Unidade</label>
                  <input class="form-control <?php echo form_status('unidade'); ?>" type="text"  name="unidade" maxlength="6" value="<?php echo set_form_value($editar,$form,'unidade'); ?>">
                </div>
                <div class="col-sm-6">
